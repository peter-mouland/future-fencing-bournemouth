...
1. Fork the project
2. Clone your fork
`git clone git@github.com:peter-mouland/future-fencing-bournemouth.git`
3. Setup your 'upstream'
`git remote add upstream https://github.com/peter-mouland/future-fencing-bournemouth.git`
